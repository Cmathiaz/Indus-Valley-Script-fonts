...
in your word processing program. In Word for MacOS, you want to drag and drop the symbols from the Fontbook. Developed using Fontforge program. If you need the original 
